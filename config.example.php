...
define('SHORT_URL', 'shortener.imac:8888');		// Your shortener URL
define('DEFAULT_URL', 'http://cspiegl.com');	// Your default redirect site
...
define('CHECK_VALID_URL', false);	// Checks if the URL returns 404 and does not create shortlink if so
...
define('CACHE_DIR', DOC_ROOT . '/data/cache');
define('TRACK_DIR', DOC_ROOT . '/data/log');
define('TRACK_FILE_NAME', date("Y_m") . '_access.log');
